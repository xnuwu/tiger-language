...
struct A_exp_ {
    ...
    union {
        ...
        struct { S_symbol var; A_exp lo, hi, body; boolean escape;} forr;
...
A_fundec A_Funcdec(A_pos pos, S_symbol name, A_fieldList params, S_symbol result, A_exp body);
